...
%>
<center>
<form name="formCont" action="post_diagnosis.asp" method="post">
<table width="800" border="0" class="table2">
    <tr> 
        <td height="21" colspan="4" class="title1">诊断方法 
    ...
    <tr> 
      ...
      <td width="180"><input name="MC" type="text" value="<%=oraRS.fields("MC").value%>"></td>
      <td width="209"><div align="right">方法：</div></td>
